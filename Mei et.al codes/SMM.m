...
%% Functionality:
% This script implements the smooth minima method (Aksoy et al. 2008, Smoothed
%  minima baseflow separation tool for perennial and intermittent streams) for
%  baseflow separation. This function is adaptable for sub-daily streamflow.
