...
%% Functionality:
% This code implements the Bump and Rise Method (BRM, Stewart 2015, Promising
%  new baseflow separation and recession analysis methods applied to streamflow
%  at Glendhu Catchment, New Zealand).
