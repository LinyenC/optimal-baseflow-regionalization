...
% First version on 6/15/2013
% Last updated on 10/6/2022

%% Functionality:
% This code implements the recursive digital filter (RDF, Eckhardt 2005, How
%  to construct recursive digital filters for baseflow separation) and the filtered
%  smooth minima method (FSMM, Aksoy et al. 2009, Filtered smoothed minima baseflow
%  separation method). If an optional Qb0 time series is provided, the FSMM filter
%  is evoked.

%% Inputs
%  Q  : streamflow time series for a basin (m^3/time step or mm/time step);
